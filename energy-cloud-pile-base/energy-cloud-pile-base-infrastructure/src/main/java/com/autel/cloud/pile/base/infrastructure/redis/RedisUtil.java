...
public class RedisUtil {
    ...
    public Object getsEntity(String key) {
        return key == null ? null : redisTemplates.opsForValue().get(key);
    }

    public Object getValueForHash(String key, String subKey) {
        return key == null ? null : redisTemplate.opsForHash().get(key, subKey);
    }
    ...
    public Boolean setForHash(String key, String subKey, Object value) {
        if (StringUtils.isBlank(key) || StringUtils.isBlank(subKey)) {
    ...
    public Boolean keyTimeOut(String key, long timeout, TimeUnit unit) {
        return redisTemplate.expire(key, timeout, unit);
    }

    public Boolean setForHash(String key, Map<String, Object> valueMap) {
    ...
    public static String buildKey(String redisData, Object... patterns) {
        StringBuilder key = (new StringBuilder(redisData)).append(":");
        int i = 0;
